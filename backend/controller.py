...
class GaragePiController:
    ...
    def get_status(self) -> Struct:
        ...
        data.garage_temp_c = self.get_garage_temperature()
        data.garage_temp_f = data.garage_temp_c * 9.0 / 5.0 + 32
        return data
    ...
    def get_garage_temperature(self) -> float:
        file = open('/tmp/garage_temp', 'r')
